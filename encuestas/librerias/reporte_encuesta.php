<?php 
	...
	class ReporteEncuesta extends FPDF{
		...
		function generar($datos){
			...
			$this->setXY(86,33);
<<<<<<< HEAD
			$this->Cell(30,5,$datos->get_anio_encuesta(),0,1,'C',false);
=======
...
>>>>>>> c714021305dfc47e4ffbc903cc4764a9c40ece04
			...
			$tmp = ($datos->get_tipo_elemento() == 'C') ? 'ENCUESTA CÁTEDRA' : 'ENCUESTA DOCENTE';
			$this->Cell(0,6,utf8_decode($tmp),1,1,'C',true);
